...
*/
  ...
  for (i=1; i<num_nodes; i++) {
	...
	pthread_create(&ParmacsThreads[ParmacsThreadNum++], NULL, (void * (*)(void *))Compute_Base, NULL);
}
#endif
...
*/
  ...
  for (i=1; i<num_nodes; i++) {
	...
	pthread_create(&ParmacsThreads[ParmacsThreadNum++], NULL, (void * (*)(void *))Or_Neighbors_In_Base, NULL);
}
#endif
