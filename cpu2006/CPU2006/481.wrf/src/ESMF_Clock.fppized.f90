...
! !ARGUMENTS:
      type(ESMF_Clock), intent(inout) :: clock
      type(ESMF_Alarm), dimension(20), intent(out), optional :: &
                                        RingingAlarmList
...
! !ARGUMENTS:
      ...
      type(ESMF_Alarm), dimension(20), intent(in) :: AlarmList
      integer, intent(out), optional :: rc
...
! !ARGUMENTS:
      ...
      type(ESMF_Alarm), dimension(20), intent(out) :: AlarmList
      integer, intent(out), optional :: rc
