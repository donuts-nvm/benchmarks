...
The SPEC version of NAMD is to be used solely for evaluating the
correctness and performance of computer systems, i.e., not for
any purpose where the actual result of the calculation is of interest.


==================================================================
The material below is from the original communications by the 
author to SPEC and may be obsolete, but is included for possible 
historical interest.
==================================================================
