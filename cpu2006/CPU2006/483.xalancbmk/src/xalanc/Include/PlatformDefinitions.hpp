...
#elif defined(__IBMCPP__) && defined(__PPC__)
#include "IBMPPCLinuxDefinitions.hpp"
#elif defined(__PGI) && defined(__WIN32__)
#include "PGIWin64Definitions.hpp"
#elif defined(__PGI)
#include "PGILinuxDefinitions.hpp"
#elif (defined(__linux__) || defined(SPEC_CPU_LINUX))
#include "LINUXDefinitions.hpp"
#else
