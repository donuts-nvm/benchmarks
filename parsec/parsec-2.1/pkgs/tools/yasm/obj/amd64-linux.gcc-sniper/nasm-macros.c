...
static const char *stdmac[] = {
    ...
    "%endmacro",
    "%endif",
    "%define __YASM_MAJOR__ 0",
    "%define __YASM_MINOR__ 7",
    "%define __YASM_SUBMINOR__ 1",
    "%define __YASM_BUILD__ 2093",
    "%define __YASM_VERSION_ID__ 000070100h",
    "%define __YASM_VER__ \"0.7.1\"",
    NULL
};
